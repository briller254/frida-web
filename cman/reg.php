...
mysqli_query($conn,"insert into members (fname,sname,lname,Gender,birthday,county,hostel,ministry,mobile,email,thumbnail,password,id) 
values('$fname','$sname','$lname','$Gender','$birthday','$county','$hostel','$ministry','$mobile','$email','uploads/none.png','$password','$mobile')")or die(mysqli_error());
