...
(1, 'Brian', 'Lagat', 'briller', 'briller@23', 'uploads/me.jpg'),
(2, 'TAITA TAVETA UNIVERSITY', 'SEVENTH DAY ADVENTIST', 'TTUSDA', '1234', 'images/NO-IMAGE-AVAILABLE.jpg');
...
INSERT INTO `members` (`keyu`, `fname`, `sname`, `lname`, `Gender`, `Birthday`,`salary`, `Home-County`, `Hostel`, `ministry`, `mobile`, `email`, `thumbnail`, `password`, `id`, `date`) VALUES
(1, 'Brian', 'lagat', 'kipkemboi', 'Male', '1999-07-22', '50000', 'Uasin Gishu', 'Block B', 'Hospitality', '0794802804', 'briller254@gmail.com', 'uploads/none.jpg', '1234', '0794802804', '2017-01-11 11:34:34'),
(3, 'SIMON', 'Obonyo', 'MUSAU', 'other', '1903-12-01', '60000','Nyeri', 'Mekatilili', 'none', '0720571204', 'email', 'uploads/none.png', '1234', '0720571204', '2017-01-11 11:34:34'),
(4, 'Moses', 'Nkoitoi', 'Tiameti', 'Male', '1990-12-19', '80000','Kiambu', 'Runda', 'Hostessing', '0723437369', 'godkde9@gmail.com', 'uploads/none.png', '0000', '0723437369', '2017-01-11 11:34:34'),
(5, 'GEOFFREY', 'Obonyo', 'MUSAU', 'Male', '2000-03-03', '40000','Nairobi', 'Mwangeka', 'Ushering', '00000000000', 'kifrey24@gmail.com', 'uploads/none.png', '0000', '0000000000', '2017-01-12 06:05:26'),
(6, 'baraka', 'abraham', 'abraham', 'Male', '1987-01-16', '20000','kiambu', 'Block C', 'Sabbath School', '0733997722', 'barakaabraham@gmail.com', 'uploads/none.png', '0000', '0733997722', '2017-02-15 05:54:40');
...
CREATE TABLE IF NOT EXISTS `sundays` (
  ...
  `Gender` varchar(100) DEFAULT NULL,
  `Birthday` varchar(100) DEFAULT NULL,
  `Home-County` varchar(100) DEFAULT NULL,
  `Hostel` varchar(100) DEFAULT NULL,
  `ministry` varchar(100) DEFAULT NULL,
  `mobile` varchar(100) DEFAULT NULL,
  `thumbnail` varchar(500) DEFAULT NULL,
...
INSERT INTO `sundays` (`keyu`, `fname`, `sname`, `lname`, `Gender`, `Birthday`, `Home-County`, `Hostel`, `ministry`, `mobile`, `thumbnail`, `id`) VALUES
...
INSERT INTO `teens` (`keyu`, `fname`, `sname`, `lname`, `Gender`, `Birthday`, `Home-County`, `Hostel`, `ministry`, `mobile`, `thumbnail`, `id`) VALUES
...
INSERT INTO `visitor` (`id`, `fname`, `sname`, `lname`, `Gender`, `Birthday`, `Home-County`, `hostel`, `ministry`, `mobile`, `thumbnail`) VALUES
