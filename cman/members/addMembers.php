...
mysqli_query($conn,"insert into members (fname,sname,lname,Gender,birthday,Home-County,pob,ministry,mobile,email,thumbnail,password) 
values('$fname','$sname','$lname','$Gender','$birthday','$HomeCounty','$pob','$ministry','$mobile','email','uploads/none.png','$password')")or die(mysqli_error());
