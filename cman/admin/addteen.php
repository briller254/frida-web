...
mysqli_query($conn,"insert into teens (fname,sname,lname,Gender,birthday,Home-County,Hostel,ministry,mobile,thumbnail,id) 
values('$fname','$sname','$lname','$Gender','$birthday','$Home-County','$Hostel','$ministry','$mobile','uploads/none.png',$mobile)")or die(mysqli_error());
